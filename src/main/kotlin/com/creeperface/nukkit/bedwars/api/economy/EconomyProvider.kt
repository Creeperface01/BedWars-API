...
interface EconomyProvider {
    ...
    fun subtractMoney(player: Player, amount: Double, currency: Currency = defaultCurrency) =
        addMoney(player.name, -amount, currency)

    fun subtractMoney(player: String, amount: Double, currency: Currency = defaultCurrency) =
        addMoney(player, -amount, currency)

    fun addMoney(player: Player, amount: Double, currency: Currency = defaultCurrency) =
        addMoney(player.name, amount, currency)
