...
/**
 * Convenience extension to read a [ConfigSection] from this JsonObject.
 */
fun <T : Any> JsonObject.getSection(section: ConfigSection<T>): T = section.getFrom(this)

/**
 * Convenience extension to write a [ConfigSection] into this JsonObject.
 * Returns a new JsonObject with the section data.
 */
fun <T : Any> JsonObject.withSection(section: ConfigSection<T>, value: T): JsonObject = section.setIn(this, value)
